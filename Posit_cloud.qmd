...
Une fois que le projet du devoir est dupliqué, vous pouvez l'utiliser puisqu'il vous appartient. De plus, le professeur peut avoir accès à votre projet RStudio directement dans son propre compte et ce, en temps réel. Si vous quittez l'espace de travail partagé avec le projet, à votre retour, les projets dupliqués possèdent une icone `Continue` (voir la @fig-continue2). Il suffit de cliquez sur cet icone pour avoir accès à votre projet partagé avec votre professeur.
