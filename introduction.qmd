...
```{r fig1, echo=FALSE, out.width='100%', fig.align='center', fig.cap="Exemple de la console R classique"}
...
```{r fig2, echo=FALSE, out.width='100%', fig.align='center', fig.cap="Illustration de la configuration de RStudio"}
...
```{r fig3, echo=FALSE, out.width='100%', fig.align='center', fig.cap="Illustration de R Notebook. Les codes sont écrits dans la fenêtre Source à la gauche et le fenêtre Viewer présente le document final"}
